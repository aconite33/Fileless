...
namespace Fileless
{
    ...
    public class TransactedAssembly : IDisposable
    {
        ...
        public Assembly Load(byte[] assemblyBytes, string assemblyName = "")
        {
            ...
            var attribsHook = engine.CreateHook("Kernel32.dll", "GetFileAttributesW", new API.DELEGATES.GetFileAttributesW(GetFileAttributesWDetour));
            //var attribsHook = engine.CreateHook("Kernel32.dll", "GetFileAttributesW"), new API.DELEGATES.GetFileAttributesW(GetFileAttributesWDetour), null);
            //attribsHook.ThreadACL.SetExclusiveACL(new int[] { -1 });

            var attribsExHook = engine.CreateHook("Kernel32.dll", "GetFileAttributesExW", new API.DELEGATES.GetFileAttributesExW(GetFileAttributesExWDetour));
            //var attribsExHook = engine.CreateHook("Kernel32.dll", "GetFileAttributesExW"), new API.DELEGATES.GetFileAttributesExW(GetFileAttributesExWDetour), null);
            //attribsExHook.ThreadACL.SetExclusiveACL(new int[] { -1 });

            var createFileHook = engine.CreateHook("Kernel32.dll", "CreateFileW", new API.DELEGATES.CreateFileW(CreateFileWDetour));
            //var createFileHook = engine.CreateHook("Kernel32.dll", "CreateFileW"), new API.DELEGATES.CreateFileW(CreateFileWDetour), null);
            //createFileHook.ThreadACL.SetExclusiveACL(new int[] { -1 });

            var infoByHandleHook = engine.CreateHook("Kernel32.dll", "GetFileInformationByHandle", new API.DELEGATES.GetFileInformationByHandle(GetFileInformationByHandleDetour));
            //var infoByHandleHook =engine.CreateHook("Kernel32.dll", "GetFileInformationByHandle"), new API.DELEGATES.GetFileInformationByHandle(GetFileInformationByHandleDetour), null);
